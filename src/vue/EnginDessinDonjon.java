...
public class EnginDessinDonjon {
	...
	private void dessinerCreature(Graphics2D g2, Position posCreature, AbstractCreature creature) {
		...
		if (creature instanceof CreatureAraignee) {
			g2.setColor(Color.CYAN);
			g2.fillOval(posCreature.getI() - 15, posCreature.getJ() - 15, LONGUEUR_CASE, LONGUEUR_CASE);
			System.out.println("araigné " + (posCreature.getJ() - 15) + " " + (posCreature.getI() - 15));
		} else if (creature instanceof CreatureDragon) {
			g2.setColor(Color.BLUE);
			g2.fillOval(posCreature.getI() - 15, posCreature.getJ() - 15, LONGUEUR_CASE, LONGUEUR_CASE);
		} else if (creature instanceof CreatureMinotaure) {
			g2.setColor(Color.GRAY);
			g2.fillOval(posCreature.getI() - 15, posCreature.getJ() - 15, LONGUEUR_CASE, LONGUEUR_CASE);
		}
	}
	 ...
	 */
	   ...
	   void dessinerJoueur(Graphics2D g2, Position posJoueur){
		   
	   g2.setColor(Color.YELLOW); g2.fillOval(posJoueur.getI()-LONGUEUR_CASE/2,
	   posJoueur.getJ()-LONGUEUR_CASE/2, LONGUEUR_CASE, LONGUEUR_CASE); }
